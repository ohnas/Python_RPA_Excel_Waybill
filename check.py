...
# new_items_list를 tuple type 으로 변환 -> db 에 저장하기 위해서 tuple로
new_items_tuple = tuple(new_items_list)

# 새로운 항목들을 db 에 insert
db_insert_cursor = conn.cursor()
insert_single_sql = "INSERT INTO single_table(품목명, 내품수량) VALUES (%s , %s) "
db_insert_cursor.executemany(insert_single_sql, new_items_tuple)
